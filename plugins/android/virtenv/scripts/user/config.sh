...
android_config_show() {
  ...
  echo ""
  echo "Application:"
  echo "  ANDROID_APP_APK: ${ANDROID_APP_APK:-*.apk}"
  echo "  ANDROID_APP_ID: ${ANDROID_APP_ID:-com.example.devbox}"
  echo "  ANDROID_APP_MAIN_ACTIVITY: ${ANDROID_APP_MAIN_ACTIVITY:-.MainActivity}"
  echo ""
