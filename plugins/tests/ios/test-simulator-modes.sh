...
echo "Scenario: Running 'ios.sh simulator start --pure max' or IN_NIX_SHELL=pure"
echo ""
echo "Expected behavior:"
...
echo "Pure mode cleanup (IN_NIX_SHELL=pure):"
...
echo "  if [ \"\${IN_NIX_SHELL:-}\" = \"pure\" ]; then"
...
echo "  # or"
echo "  IN_NIX_SHELL=pure devbox run test:e2e"
echo ""

echo "Environment detection:"
echo "  Normal mode: IN_NIX_SHELL=impure or unset"
echo "  Pure mode: IN_NIX_SHELL=pure (set automatically by 'devbox run --pure')"
echo ""
